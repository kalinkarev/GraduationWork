        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                if (TextUtils.isEmpty(price)) {
                    ...
                    finalPrice = Integer.parseInt(price.toString());
                ...
                if (optionForAllDay == 1) {
                    ...
                    newDuration.setStart(startDate.getTimeInMillis() + 1800000);
                    newDuration.setFinish(endDate.getTimeInMillis() + 5400000);
                }
                ...
                Log.d("The start time is", String.valueOf(newDuration.getStart()));
                Log.d("The end time is", String.valueOf(newDuration.getFinish()));

...
//                        startDate.getTimeInMillis()));
        ...
        noevents = (LinearLayout) mainView.findViewById(R.id.linearLayoutForNoEvents);
        statictics = (RelativeLayout) mainView.findViewById(R.id.relativeLayoutForStatistics);

        if (events.size() == 0) {
            noevents.setVisibility(View.VISIBLE);
            statictics.setVisibility(View.GONE);
        } else {
            noevents.setVisibility(View.GONE);
            statictics.setVisibility(View.VISIBLE);
        }
        ...
        if (events.size() > 0) {
            ...
            Log.d("The start time", String.valueOf(start));
            Log.d("The finish time", String.valueOf(finish));
        }
